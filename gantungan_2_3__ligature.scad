...
/* [Font Settings] */
Font_Name = "Bagel Fat One, Segoe UI Symbol, Segoe UI Emoji"; // font [Bagel Fat One, Chewy, Courgette, Dancing Script, Lemon, Lobster, Pacifico, Playfair, Lily Script One, Sacramento, Bubblegum Sans, DynaPuff, Alkatra, Archivo, Sour Gummy, Shrikhand]
Font_Size = 13;
Font_Weight_Steps = 0;
...
Line2_Spacing      = 1.42; // Jarak presisi optimal (bebas sentuhan ekor q/y Baris 2 ke Baris 3)
Line3_Spacing      = 1.42; // Jarak presisi optimal (bebas sentuhan ekor q/y Baris 2 ke Baris 3)
Offset_L1          = 0;
Offset_L2          = 0;
Offset_L3          = 0;
