...
// Merender baris secara per-karakter agar perhitungan koordinat spasi 100% sinkron (Center Align)
module render_line(word) {
    align_shift = -get_word_width(word) / 2;
